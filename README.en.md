...
> **Status:** working and confirmed on hardware — **NLCN38WW**, and **NLCN39WW**
> by byte-level module identity. One binary covers NLCN37/38/39. The patch is
...
8. [UEFI Shell access](docs/08-uefi-shell-access.md) — reach the UEFI Shell from Windows or Linux.

Документация на русском: **[docs/ru/](docs/ru/README.md)** · README: [Русский](README.md).
